...
using System.Linq;
using System.Text;
                      //cool: get the length of the file (input array) and make it a public constant (p). Also, make N a constant as well.  
                        //also, get the nearest neighbor distance to a number so you don't have to mess around with calling so many methods. 
                            //come back to 5 because you need to convert it to many different units. 
