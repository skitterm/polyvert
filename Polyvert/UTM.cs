...
namespace Cartography
{
    public class UTM
    {
        ...
        public static Structure.UTMCoord utm1(Structure.GeoPoint latlong, Structure.Ellipsoidcoord ellip, double longMax, double longMin)
        {// 9 a. 
            ...
            if (latlong.latitudeDeg >= 56.0 && latlong.latitudeDeg < 64.0)
            {
                if (latlong.longitudeDeg >= 3.0 && latlong.longitudeDeg < 12.0)
                    utm.zoneNumber = 32;
                //  MessageBox.Show("The adjusted zone number is " + ZoneNumber.ToString());
            }
            ...
            //const double piover2 = Constant.PI / 2;
            //const double piover2neg = Constant.PI / -2;

            //if ((latlong.latitudeDeg = piover2) || (latlong.latitudeDeg = piover2neg))
            //{
        ...
        public static Structure.GeoPoint utm2(Structure.UTMCoord utm, Structure.Ellipsoidcoord ellip)
        {//9 b.
